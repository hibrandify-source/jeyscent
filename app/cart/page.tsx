...
export default function CartPage() {
    ...
    return (
      <div className="page-transition pt-24 lg:pt-28">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 py-20 lg:py-32 text-center">
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="mx-auto mb-8 text-muted">
  ...
  // totalPrice from context is already sum of getSalePrice(item.price) × qty
  const shippingFree = totalPrice >= 200000;
  const shippingCost = shippingFree ? 0 : 3000;
  ...
  return (
    <div className="page-transition pt-24 lg:pt-28">
      ...
      <div className="bg-black text-white py-10 lg:py-14 text-center">
        <h1 className="text-3xl lg:text-4xl tracking-wide" style={{ fontFamily: "'Playfair Display', serif" }}>
          Your Bag
        </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
              ...
              <div className="mb-8 p-4 bg-cream text-center">
                ...
                <div className="mt-2 bg-gray-200 h-1 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${Math.min((totalPrice / 200000) * 100, 100)}%` }}
                  />
                </div>
              </div>
            )}
                  ...
                  >
                    ...
                    <div className="lg:contents space-y-3 lg:space-y-0">
                      ...
                      <div className="lg:hidden">
                        <Link href={`/shop/${item.productId}`} className="text-sm font-medium">
                          {item.name}
                        </Link>
          ...
          <div className="lg:col-span-1">
            <div className="bg-cream p-8 sticky top-28">
              <h3 className="text-lg tracking-wide mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                Order Summary
              </h3>
